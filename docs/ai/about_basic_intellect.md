...
Refer to [about_basic_intellect_lead_investigations.md](about_basic_intellect_lead_investigations.md) for the lead investigations logic.
...
Refer to [about_basic_intellect_purchasing.md](about_basic_intellect_purchasing.md) for the purchasing logic.
