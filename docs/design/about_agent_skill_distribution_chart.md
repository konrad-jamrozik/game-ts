...
- `n = 10`
- `i25 = ceil(2.5) - 1 = 2`, `i50 = ceil(5) - 1 = 4`, `i75 = ceil(7.5) - 1 = 7`, `i95 = ceil(9.5) - 1 = 9`
...
- Red: `4 <= skill < 4` → impossible (0 agents, p75 = p95)
- Dark Red: `skill >= 4` → all 4s (5 agents)

Result:

- Green: `1 1 1 1 1` (5 agents)
- Dark Red: `4 4 4 4 4` (5 agents)
...
- `p25 = 200`, `p50 = 200`, `p75 = 400`, `p95 = 400`
...
- Red: `400 <= skill < 400` → impossible (0 agents, p75 = p95)
- Dark Red: `skill >= 400` → 400, 400, 400 (3 agents)

Result:

- Green: `100 100 200 200 200` (5 agents)
- Orange: `300 300` (2 agents)
- Dark Red: `400 400 400` (3 agents)

### Key Properties

**Stability**: Raising low-end skills does not reduce the Dark Red band unless the 95th-percentile cutpoint value changes. This prevents bottom changes from cascading upward.
...
- **Yellow, Orange, Red, Dark Red bands**: Displayed as `(minSkill, maxSkill]` (half-open interval)
- **Empty bands**: Not displayed (zero height in the stacked chart)
- **Band colors**: Green → Yellow → Orange → Red → Dark Red (from lowest to highest skills)
...
- `n = 2`: `i25 = 0`, `i50 = 0`, `i75 = 1`, `i95 = 1` → Green and Dark Red only
- `n = 3`: `i25 = 0`, `i50 = 1`, `i75 = 2`, `i95 = 2` → Green, Yellow, and Dark Red
