...
import type { Agent, GameState, MissionSite } from '../src/model/lib/model'
import { updateDeployedMissionSite } from '../src/model/turn_advancement/updateDeployedMissionSite'
