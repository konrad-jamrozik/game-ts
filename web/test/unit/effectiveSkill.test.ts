...
import { fromF2, toF2 } from '../../src/lib/model/fixed2'
...
describe(effectiveSkill, () => {
  test('no exhaustion, no hit points lost', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(100)
  })
  ...
  test('exhaustion only', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(98)
  })
  ...
  test('hit points lost only', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(76)
  })
  ...
  test('exhaustion and hit points lost', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(97)
  })
  ...
  test('high exhaustion', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(20)
  })
  ...
  test('100% exhaustion', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(5)
  })
  ...
  test('105% exhaustion', () => {
    ...
    expect(fromF2(effectiveSkill(agent))).toBe(0)
  })
