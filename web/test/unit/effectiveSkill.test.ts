...
import { fromFixed2, toFixed2 } from '../../src/lib/model/fixed2'
...
describe(effectiveSkill, () => {
  test('no exhaustion, no hit points lost', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(100)
  })
  ...
  test('exhaustion only', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(98)
  })
  ...
  test('hit points lost only', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(76)
  })
  ...
  test('exhaustion and hit points lost', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(97)
  })
  ...
  test('high exhaustion', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(20)
  })
  ...
  test('100% exhaustion', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(5)
  })
  ...
  test('105% exhaustion', () => {
    ...
    expect(fromFixed2(effectiveSkill(agent))).toBe(0)
  })
