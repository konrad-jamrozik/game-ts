...
describe(getRecoveryTurns, () => {
  ...
  test.each<[string, number, number, number, number]>([
    ...
    // Exact divisions
    [' 10/100 hp left -> 90.00% damage ->  1 turn', 100,  90, 2,  45],
    [' 20/100 hp left -> 80.00% damage ->  2 turn', 100,  80, 2,  40],
    [' 50/100 hp left -> 50.00% damage ->  5 turn', 100,  50, 2,  25],
    [' 90/100 hp left -> 10.00% damage ->  9 turn', 100,  10, 2,   5],
  ])(
