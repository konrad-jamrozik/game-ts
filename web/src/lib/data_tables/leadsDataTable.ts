...
export function bldLeadsTable(factions: readonly FactionData[]): readonly Lead[] {
  ...
  ['lead-{facId}-interrogate-lieutenant',     'Inter. {facName} lieutenant',             6,         false,      'Extract information from the captured lieutenant.',                                           ['missiondata-raid-{facId}-trainfac'],                                                         ],
  ...
  ['lead-{facId}-interrogate-high-commander', 'Inter. {facName} high commander',        20,         false,      'Extract information from the captured high commander.',                                       ['missiondata-raid-{facId}-stronghold'],                                                       ],
  ['lead-{facId}-hq',                         'Locate {facName} HQ',                   100,         false,      'Location of the {facName} headquarters has been revealed.',                                   ['lead-{facId}-interrogate-high-commander'],                                                   ],
