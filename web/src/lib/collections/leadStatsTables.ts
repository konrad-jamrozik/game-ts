...
export const LEADS_DATA: LeadStats[] = toLeadStats([
  ...
  ['lead-{facId}-interrogate-member', 'Interrogate member', 'Extract information from the captured member.', 2, ['mission-apprehend-cult-member-{facId}'], false],
  ...
  ['lead-{facId}-interrogate-handler', 'Interrogate handler', 'Extract information from the captured handler.', 2, ['mission-raid-{facId}-safehouse'], false],
  ...
  ['lead-{facId}-interrogate-soldier', 'Interrogate soldier', 'Extract information from the captured soldier.', 4, ['mission-raid-{facId}-outpost'], false],
  ...
  ['lead-{facId}-interrogate-lieutenant', 'Interrogate lieutenant', 'Extract information from the captured lieutenant.', 6, ['mission-raid-{facId}-trainfac'], false],
  ...
  ['lead-{facId}-interrogate-commander', 'Interrogate commander', 'Extract information from the captured commander.', 10, ['mission-raid-{facId}-logistics-hub'], false],
  ...
  ['lead-{facId}-analyze-command-structure', 'Analyze command structure', 'Analyze the {facName} command structure.', 15, ['mission-raid-{facId}-command-center'], false],
  ...
  ['lead-{facId}-interrogate-high-commander', 'Interrogate high commander', 'Extract information from the captured high commander.', 20, ['mission-raid-{facId}-stronghold'], false],
  ...
  ['lead-{facId}-interrogate-leader', 'Interrogate cult leader', 'Extract information from the captured cult leader.', 30, ['mission-raid-{facId}-hq'], false],
