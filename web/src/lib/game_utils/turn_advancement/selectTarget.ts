...
export function selectTarget<T extends Agent | Enemy>(
  ...
  // KJA3_3 this silly fallback is inefficient
  ...
  const randomIndex = rollIntIncToInc(0, targetsWithMinAttacks.length - 1).roll
