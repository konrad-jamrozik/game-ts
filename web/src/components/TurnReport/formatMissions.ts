...
function formatMissionReport(mission: MissionReport): TreeViewBaseItem<TurnReportTreeViewModelProps> {
  ...
  return {
    ...
    children: [
      {
        id: `mission-${mission.missionId}-outcome`,
        label: 'Outcome',
        chipValue: mission.outcome,
      },
      {
        id: `mission-${mission.missionId}-faction`,
        label: 'Faction',
      ...
      {
        id: `mission-${mission.missionId}-rounds`,
        label: 'Rounds',
        chipValue: mission.rounds,
        noColor: true,
        noPlusSign: true,
      },
      ...(mission.rewards !== undefined ? [formatRewards(mission.missionId, mission.rewards)] : []),
      formatBattleStats(mission.missionId, mission.battleStats),
    ],
  }
}
...
function formatRewards(
  ...
  if (rewards.money !== undefined) {
    children.push({
      id: `mission-${missionId}-reward-money`,
      label: 'Money',
  ...
  if (rewards.funding !== undefined) {
    children.push({
      id: `mission-${missionId}-reward-funding`,
      label: 'Funding',
  ...
  if (rewards.panicReduction !== undefined) {
    children.push({
      id: `mission-${missionId}-reward-panic-reduction`,
      label: 'Panic',
  ...
  if (rewards.factionRewards !== undefined && rewards.factionRewards.length > 0) {
    ...
    if (factionReward?.suppression !== undefined) {
      children.push({
        id: `mission-${missionId}-reward-faction-suppression`,
...
function formatBattleStats(
  ...
  return {
    id: `mission-${missionId}-battle-stats`,
    label: 'Battle stats',
    children: [
      {
        id: `mission-${missionId}-battle-stats-agents-deployed`,
      ...
      {
        id: `mission-${missionId}-battle-stats-agents-unscathed`,
        label: 'Agents unscathed',
        chipValue: agentsUnscathed,
        noPlusSign: true,
      },
      {
        id: `mission-${missionId}-battle-stats-agents-wounded`,
      ...
      {
        id: `mission-${missionId}-battle-stats-agents-terminated`,
      ...
      {
        id: `mission-${missionId}-battle-stats-enemies-total`,
        label: 'Enemies total',
      ...
      {
        id: `mission-${missionId}-battle-stats-enemies-unscathed`,
      ...
      {
        id: `mission-${missionId}-battle-stats-enemies-wounded`,
      ...
      {
        id: `mission-${missionId}-battle-stats-enemies-terminated`,
        label: 'Enemies terminated',
        chipValue: enemiesTerminated,
        noPlusSign: true,
      },
      {
        id: `mission-${missionId}-battle-stats-total-agent-hp-at-battle-start`,
      ...
      {
        id: `mission-${missionId}-battle-stats-total-enemy-hp-at-battle-start`,
      ...
      {
        id: `mission-${missionId}-battle-stats-total-agent-skill-at-battle-start`,
      ...
      {
        id: `mission-${missionId}-battle-stats-total-enemy-skill-at-battle-start`,
      ...
      {
        id: `mission-${missionId}-battle-stats-total-damage-inflicted`,
        label: `Total damage inflicted (${damageInflictedPctStr} of enemy HP)`,
        chipValue: totalDamageInflicted,
        noPlusSign: true,
      },
      {
        id: `mission-${missionId}-battle-stats-total-damage-taken`,
      ...
      {
        id: `mission-${missionId}-battle-stats-total-agent-skill-gain`,
        label: `Total agent skill gain (${skillGainPctStr} of init. skill)`,
        chipValue: f6fmtInt(totalAgentSkillGain),
        noPlusSign: true,
      },
      {
        id: `mission-${missionId}-battle-stats-average-agent-exhaustion-gain`,
