...
export function getShopCapabilitiesColumns(): GridColDef<UpgradeRow>[] {
  return [
    ...getBaseCapabilitiesColumns<UpgradeRow>(),
    {
      field: 'upgrade',
      headerName: 'Upgrade',
      width: columnWidths['operations_capacities.upgrade'],
    },
    {
      field: 'price',
      headerName: 'Price',
      width: columnWidths['operations_capacities.price'],
    },
  ]
}
  ...
  return [
    {
      field: 'name',
      headerName: 'Capacity',
      width: columnWidths['operations_capacities.name'],
    ...
    },
    {
      ...
      width: columnWidths['operations_capacities.value'],
